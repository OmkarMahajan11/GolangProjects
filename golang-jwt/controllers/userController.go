...
import (
	...
	"example.com/golang-jwt/helpers"
	"example.com/golang-jwt/models"
	...
	return func(c *gin.Context) {
		...
		projectStage := bson.D{
			{"$project", bson.D{
				{"_id", 0},
				{"total_count", 1},
				{"user_ids", bson.D{{"$slice", []interface{}{"$data", startIndex, recordPerPage}}}}},
			},
		}
...
func verifyPassword(p1, p2 string) (bool, string) {
